    ...
    <div className="px-4 sm:px-20 xl:px-32 my-18">
      ...
      <div className="flex flex-wrap mt-10 justify-center">
        {AiToolsData.map((tool , index)=>(
            <div onClick={()=> user && navigate(tool.path)} className="p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition-all duration-300 cursor-pointer" key={index}>
